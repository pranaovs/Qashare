...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/expenses/{id}": {
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "Returns updated expense with all fields",
                        "schema": {
                            "$ref": "#/definitions/models.ExpenseDetails"
                        }
                    },
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Partial expense details (all fields optional except where validation requires)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "BAD_REQUEST: Invalid request body or validation failed | INVALID_SPLIT: Split totals do not match expense amount",
                        "schema": {
                            "$ref": "#/definitions/apierrors.AppError"
                        }
                    },
        ...
        "/v1/groups/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Partial group details (name and/or description, all optional)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Returns updated group with all fields",
                        "schema": {
                            "$ref": "#/definitions/models.GroupDetails"
                        }
                    },
        ...
        "/v1/me": {
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Partial user details (name and/or email, all optional)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v2/groups/{id}/expenses": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Cursor (expense_id) for next page. Omit for first page.",
                        "name": "cursor",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.PaginatedResponse-models_Expense"
                        }
                    },
                    "400": {
                        "description": "BAD_REQUEST: Invalid cursor format",
                        "schema": {
                            "$ref": "#/definitions/apierrors.AppError"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/models.PaginatedResponse-models_Settlement"
                        }
                    },
                    "400": {
                        "description": "BAD_REQUEST: Invalid cursor format",
        ...
        "/v2/groups/{id}/spendings": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Paginated list of user expenses",
                        "schema": {
                            "$ref": "#/definitions/models.PaginatedResponse-models_UserExpense"
                        }
                    },
                    "400": {
                        "description": "BAD_REQUEST: Invalid cursor format",
    ...
    "definitions": {
        ...
        "models.PaginatedResponse-models_Expense": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "models.PaginatedResponse-models_Settlement": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "models.PaginatedResponse-models_UserExpense": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
